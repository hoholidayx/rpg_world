...
class SessionDataService:
    ...
    def delete_pending_plot_injection_requested_for_turn(
        ...
        return self._plot.delete_pending_injection_requested_for_turn(
            str(session_id),
            int(turn_id),
        )
    ...
    def delete_pending_plot_injection_requested_from_turn(
        ...
        return self._plot.delete_pending_injection_requested_from_turn(
            str(session_id),
            int(turn_id),
        )
    ...
    def retain_pending_plot_injection_requested_turns(
        ...
        return self._plot.retain_pending_injection_requested_turns(
            str(session_id),
            turn_ids,
        )

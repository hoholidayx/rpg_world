...
from dashboard_api import deps as api_deps
from dashboard_api.routers import chat as chat_router
from dashboard_api.routers import sessions as sessions_router
from dashboard_api.routers import workspace as workspace_router
...
class FakeAgent:
    ...
    async def send_stream(self, message: str):
        from rpg_core.agent.agent_types import AgentStreamEvent

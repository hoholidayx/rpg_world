...
const toneClass = {
  ...
  plot: 'bg-sky-100 text-sky-700 ring-sky-100 dark:bg-sky-500/20 dark:text-sky-100 dark:ring-sky-500/20',
  outcome: 'bg-violet-100 text-violet-700 ring-violet-100 dark:bg-violet-500/20 dark:text-violet-100 dark:ring-violet-500/20',

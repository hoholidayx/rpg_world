"""MilestoneManager — manage milestone entries with full CRUD."""
...
from rpg_world.rpg_core.milestone.loader import MilestoneLoader


class MilestoneManager(BaseManager):
    """Manages milestone entries in memory with CRUD operations.
    ...
    def __init__(self, path: str | Path) -> None:
        ...
        self.loader = MilestoneLoader(self.path)
    ...
    def reload(self) -> None:
        ...
        logger.info("MilestoneManager.reload from %s", self.path)
    ...
    def get_entry(self, name: str) -> dict[str, Any]:
        ...
        try:
            ...
            raise FileNotFoundError(f"Milestone entry not found: {name}") from None
    ...
    def delete_entry(self, name: str) -> None:
        """Delete a milestone entry by name.

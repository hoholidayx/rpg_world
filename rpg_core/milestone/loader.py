"""MilestoneLoader — load/save milestone entries from/to JSON."""
...
class MilestoneLoader:
    """File I/O for milestone entries.
    ...
    **Directory of entry files**::
        ...
        path/
        ├── first_milestone.json  {"name":"First Milestone","content":"…", …}
        └── second_milestone.json {"name":"Second Milestone","content":"…", …}
    """
    ...
    def delete(self, name: str) -> None:
        ...
        raise FileNotFoundError(
            "Use MilestoneManager.delete_entry() for single-file mode"
        )

...
class AgentSessionService:
    ...
    async def reset_session(self) -> "SessionResetResult":
        ...
        logger.info(
            _TAG
            + " session reset completed: session_id={}, messages={}, outcomes={}, plot_decisions={}, pending_plot_injections={}, plot_scene_opportunities={}, story_memories={}, story_status_tables_cleared={}, story_status_tables_initialized={}, native_status_tables_reset={}, first_message_appended={}",
            session_id,
            ...
            result.plot_scene_opportunities_cleared,

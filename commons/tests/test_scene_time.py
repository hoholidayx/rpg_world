...
def test_scene_time_strict_parse_format_and_ordinal() -> None:
    value = SceneTime.parse("3 年 6 月 15 日 14 时 30 分")

    assert value == SceneTime(3, 6, 15, 14, 30)
    assert value.format() == "3 年 6 月 15 日 14 时 30 分"
    assert SceneTime.parse("3 年 6 月 15 日 14 时").minute == 0

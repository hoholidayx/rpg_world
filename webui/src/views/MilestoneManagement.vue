<template>
  <div class="milestone-mgmt">
    ...
    >
      ...
      <template #emptyText>
        <a-empty description="暂无里程碑，点击「新增里程碑」创建" />
      </template>
    </a-table>
...
const columns = [
  ...
  { title: '一句话描述', dataIndex: 'description', key: 'description', ellipsis: true, width: 220 },

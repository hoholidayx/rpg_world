"""Shared prompt, parsing, and fusion helpers for retrieval rerankers."""
...
from memory_retrieval.retrieval.scoring import normalize_values
...
PointwisePromptBuilder = Callable[[str, MemoryCandidate, int], str]
...
def build_pointwise_prompt(
    ...
    *,
    instructions: str = MEMORY_RERANK_POINTWISE_INSTRUCTIONS,
    candidate_context: str = "",
) -> str:
    """Build a business-neutral pointwise relevance prompt."""

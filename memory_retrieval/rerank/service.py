"""Provider-agnostic retrieval rerank logic."""
...
from memory_retrieval.rerank.providers import ChatPointwiseScoreProvider, LogitRerankProvider, MemoryScoreProvider
...
class PointwiseMemoryReranker(MemoryReranker):
    ...
    def __init__(
        ...
        *,
        ...
        self._score_provider = _as_score_provider(
            provider,
...
def _as_score_provider(
    provider: object,
    *,
    max_candidate_chars: int,
    system_prompt: str,
    prompt_builder: PointwisePromptBuilder,
) -> MemoryScoreProvider:
    ...
    return ChatPointwiseScoreProvider(  # type: ignore[arg-type]
        provider,
        max_candidate_chars=max_candidate_chars,
        system_prompt=system_prompt,
        prompt_builder=prompt_builder,

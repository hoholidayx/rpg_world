...
OPENAI_API_DIALECT_OPENAI = "openai"
OPENAI_API_DIALECT_DEEPSEEK = "deepseek"
OPENAI_API_DIALECTS = frozenset(
    {OPENAI_API_DIALECT_OPENAI, OPENAI_API_DIALECT_DEEPSEEK}
)

THINKING_MODE_ENABLED = "enabled"
THINKING_MODE_DISABLED = "disabled"
THINKING_MODES = frozenset({THINKING_MODE_ENABLED, THINKING_MODE_DISABLED})

REASONING_EFFORT_HIGH = "high"
REASONING_EFFORT_MAX = "max"
REASONING_EFFORTS = frozenset({REASONING_EFFORT_HIGH, REASONING_EFFORT_MAX})

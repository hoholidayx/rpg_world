"""CLI for the fixed RPG Memory benchmark workflow."""
...
from rpg_memory.benchmark.datasets import SUPPORTED_DATASETS, parse_datasets
from rpg_memory.benchmark.suite import (
    default_options,
    execute_suite,
...
def main() -> None:
    ...
    command = "uv run python -m rpg_memory.benchmark " + shlex.join(sys.argv[1:])
...
def _quiet_runtime_logs() -> None:
    logger.disable("memory_retrieval")
    logger.disable("rpg_memory")
